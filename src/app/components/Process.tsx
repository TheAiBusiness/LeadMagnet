...
const steps = [
  {
    num: "01",
    title: "Auditoría",
    desc: "Analizamos tu operación, identificamos cuellos de botella y mapeamos oportunidades de automatización.",
    detail: "Gratis · 1 semana",
  },
  {
    num: "02",
    title: "Implementación",
    desc: "Desplegamos soluciones de IA a medida, integradas con tus herramientas actuales.",
    detail: "2 – 4 semanas",
  },
  {
    num: "03",
    title: "Escalado",
    desc: "Optimizamos, medimos resultados y ampliamos la automatización a más áreas.",
    detail: "Continuo",
  },
];
