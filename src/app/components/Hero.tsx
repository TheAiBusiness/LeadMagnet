  ...
  return (
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto text-center relative z-10">
        ...
        >
          <BlurWords text={t("hero.headline1")} delay={0.15} />
          <br />
          ...
          <BlurWords text={t("hero.headline3")} delay={0.82} />
          <br className="hidden sm:inline" />
          <span className="sm:hidden"> </span>
          <BlurWords text={t("hero.headline4")} delay={0.95} />
          <br className="sm:hidden" />
          <span className="hidden sm:inline"> </span>
          <BlurWords text={t("hero.headline5")} delay={1.05} />
        </h1>
