    ...
    <motion.button
      ...
      transition={
        justClicked
          ...
          : { duration: 0.4, delay: active ? 0 : delay, ease: [0.25, 0.46, 0.45, 0.94] as const }
      }
...
const slideTrans = { duration: 0.45, ease: [0.25, 0.46, 0.45, 0.94] as const };
...
export function Calculator({ id }: CalculatorProps) {
  ...
  const submit = async () => {
    setErr("");
    if (!email || !email.includes("@") || !email.includes(".")) { setErr("Email no válido"); return; }
          ...
          <AnimatePresence mode="wait" custom={dir}>
            ...
            {step === 1 && (
              <motion.div key="q1" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  ...
                  ¿En qué sector<br />opera tu negocio?
                </motion.h2>
                <div className="flex flex-wrap gap-2.5">
                  {SECTORS.map((s, i) => <Pill key={s} active={sector === s} onClick={() => { setSector(s); autoAdvance(); }} big delay={0.2 + i * 0.04} groupId="sector">{s}</Pill>)}
                </div>
              </motion.div>
            )}
            ...
            {step === 2 && (
              <motion.div key="q2" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  className="text-[#0B0B0B] mb-8" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                  ¿Cuántas personas<br />sois en el equipo?
                </motion.h2>
                <div className="flex flex-wrap gap-2.5">
            ...
            {step === 3 && (
              <motion.div key="q3" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  className="text-[#0B0B0B] mb-8" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                  ¿Cuál es vuestra<br />facturación anual?
                </motion.h2>
                <div className="flex flex-wrap gap-2.5">
            ...
            {step === 4 && (
              <motion.div key="q4" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  className="text-[#0B0B0B] mb-8" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                  ¿Ya usáis inteligencia<br />artificial en algún proceso?
                </motion.h2>
                <div className="flex gap-3">
                  <Pill active={usesAI === false} onClick={() => { setUsesAI(false); autoAdvance(); }} big delay={0.2} groupId="usesai">No, aún no</Pill>
                  <Pill active={usesAI === true} onClick={() => { setUsesAI(true); autoAdvance(); }} big delay={0.24} groupId="usesai">Sí, ya usamos</Pill>
                </div>
              </motion.div>
            )}
            ...
            {step === 5 && (
              <motion.div key="q5" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  ...
                  ¿Qué tareas os quitan<br />más tiempo?
                </motion.h2>
                <motion.p initial={{ opacity: 0, filter: "blur(6px)" }} animate={{ opacity: 1, filter: "blur(0px)" }} transition={{ duration: 0.4, delay: 0.2 }}
                  className="text-[#0B0B0B]/30 mb-8" style={{ fontSize: "0.85rem" }}>Selecciona todas las que apliquen</motion.p>
                <div className="flex flex-wrap gap-2.5">
                  {TASKS.map((t, i) => <Pill key={t.label} active={tasks.includes(t.label)} onClick={() => toggleTask(t.label)} big delay={0.25 + i * 0.035} multi>{t.label}</Pill>)}
                </div>
              </motion.div>
            )}
            ...
            {step === 6 && (() => {
              const mc = buildMetricsConfig(sector, teamSize, revenue, usesAI, tasks);
              ...
              return (
                <motion.div key="q6" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                  ...
                  <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                    className="text-[#0B0B0B] mb-2" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                    Ajusta tus métricas<br />operativas
                  </motion.h2>
            ...
            {step === 7 && (() => {
              ...
              return (
                <motion.div key="q7" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                  ...
                  <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                    className="text-[#0B0B0B] mb-2" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                    ¿Cuál es vuestro<br />ticket medio?
                  </motion.h2>
                  <motion.p initial={{ opacity: 0, filter: "blur(8px)" }} animate={{ opacity: 1, filter: "blur(0px)" }} transition={{ duration: 0.4, delay: 0.22 }}
                    ...
                    El valor medio de cada transacción es clave para calcular tu potencial de ingresos con AI.
                  </motion.p>
            ...
            {step === 8 && (
              <motion.div key="q8" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  className="text-[#0B0B0B] mb-8" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                  ¿Necesitáis atención<br />fuera de horario?
                </motion.h2>
                <div className="flex gap-3">
                  <Pill active={h24 === false} onClick={() => { setH24(false); autoAdvance(); }} big delay={0.2} groupId="h24">No, horario estándar</Pill>
                  <Pill active={h24 === true} onClick={() => { setH24(true); autoAdvance(); }} big delay={0.24} groupId="h24">Sí, 24/7</Pill>
                </div>
              </motion.div>
            )}
            ...
            {step === 9 && (
              <motion.div key="q9" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}>
                ...
                <motion.h2 initial={{ opacity: 0, filter: "blur(14px)", y: 10 }} animate={{ opacity: 1, filter: "blur(0px)", y: 0 }} transition={{ duration: 0.5, delay: 0.15 }}
                  className="text-[#0B0B0B] mb-8" style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 600, lineHeight: 1.15 }}>
                  ¿Cuál es tu<br />prioridad principal?
                </motion.h2>
                <div className="flex flex-wrap gap-2.5">
                  {PRIORITIES.map((p, i) => <Pill key={p} active={priority === p} onClick={() => { setPriority(p); autoAdvance(); }} big delay={0.2 + i * 0.04} groupId="priority">{p}</Pill>)}
                </div>
              </motion.div>
            )}
              ...
              <motion.div key="q10" custom={dir} variants={slideAnim} initial="enter" animate="center" exit="exit" transition={slideTrans}
                ...
                >
                  <div className="space-y-4 mb-5">
                    {[
                      { label: "Ahorro / mes", icon: Euro, val: `€ ${fmt(calc.monthlySav)}` },
                      { label: "Ingreso adicional", icon: TrendingUp, val: `€ ${fmt(calc.addRev)}` },
                      { label: "Mejora respuesta", icon: Clock, val: `–${calc.respImprove}%` },
                      { label: "AI Score", icon: BarChart3, val: `${calc.score}/100` },
                    ].map((m) => (
                      <div key={m.label}>
                  ...
                  <div className="pt-4 border-t border-[#EBEBEB]">
                    <p className="text-[#0B0B0B]/25 mb-1" style={{ fontSize: "0.6rem", fontWeight: 500, letterSpacing: "0.12em" }}>IMPACTO TOTAL / MES</p>
                ...
                >
                  Desbloquea tu<br />informe personalizado
                </motion.h2>
                <motion.p
                ...
                <div className="max-w-[440px] space-y-4">
                  ...
                  <motion.button
                    ...
                    className={`w-full py-4 mt-4 bg-[#0B0B0B] text-white rounded-full shadow-[0_4px_20px_rgba(11,11,11,0.08)] ${submitting ? "opacity-70 cursor-wait" : "cursor-pointer"}`}
                    style={{ fontSize: "1.05rem", fontWeight: 500 }}
                  >
                    {submitting ? "Enviando…" : "Desbloquear informe"}
                  </motion.button>
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            {step === 10 && done && (
              <motion.div key="done" initial={{ opacity: 0, scale: 0.96, filter: "blur(16px)" }} animate={{ opacity: 1, scale: 1, filter: "blur(0px)" }}
                ...
                >
                  <motion.button onClick={openCalendly} whileHover={{ scale: 1.03, boxShadow: "0 8px 30px rgba(11,11,11,0.12)" }} whileTap={{ scale: 0.97 }}
        ...
        <div className="flex-1 overflow-y-auto px-7 py-8">
            ...
            {(sector || teamSize) && (
              ...
              >
                <p className="text-[#0B0B0B]/60" style={{ fontSize: "0.78rem" }}>
                  {[sector, teamSize && `${teamSize} pers.`, revenue].filter(Boolean).join(" · ")}
                </p>
          ...
          {!done ? (
            <>
              ...
              >
                ...
                <p className="text-[#0B0B0B]/25" style={{ fontSize: "0.68rem", lineHeight: 1.6 }}>
                  Completa todas las preguntas para desbloquear tus resultados.
                </p>
              </motion.div>
            </>
          ) : (
            <motion.div initial={{ opacity: 0, filter: "blur(14px)" }} animate={{ opacity: 1, filter: "blur(0px)" }} transition={{ duration: 0.7 }}>
              <div className="space-y-4 mb-6">
                {[
                  { label: "Ahorro operativo / mes", val: `€ ${fmt(calc.monthlySav)}`, sub: `${calc.hrsSaved}h liberadas × ${costH}€/h × overhead equipo`, icon: Euro },
                  { label: "Ingreso adicional / mes", val: `€ ${fmt(calc.addRev)}`, sub: `${fmt(leads)} leads × boost conv. × €${fmtTicket(avgTicket)} ticket`, icon: TrendingUp },
                  { label: "Tiempo respuesta", val: `${respTime} → ${calc.newResp} min`, sub: `–${calc.respImprove}% · media ${sector}: ${({ Ecommerce: 35, SaaS: 20, Agencia: 45, Servicios: 55, Salud: 30, Inmobiliaria: 75, Logística: 50, Otros: 40 } as Record<string,number>)[sector] || 40}min`, icon: Clock },
                  { label: "AI Score", val: `${calc.score}/100`, sub: calc.score >= 75 ? "Muy alto potencial" : calc.score >= 55 ? "Alto potencial" : calc.score >= 35 ? "Moderado" : "Inicial", icon: BarChart3 },
                ].map((m, i) => (
              ...
              >
                <p className="text-white/40 mb-1" style={{ fontSize: "0.6rem", letterSpacing: "0.12em" }}>IMPACTO TOTAL / MES</p>
              ...
              >
                * Estimaciones basadas en benchmarks del sector {sector}, eficiencia AI ({Math.round(({ SaaS: 1.15, Ecommerce: 1.10, Logística: 1.08, Agencia: 1.05, Servicios: 1.00, Inmobiliaria: 0.95, Salud: 0.92, Otros: 1.00 } as Record<string,number>)[sector] * 100 || 100)}%){usesAI ? ", descontando IA existente" : ""}.
              </motion.p>
            </motion.div>
          )}
            </div>
